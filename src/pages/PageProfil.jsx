...
const BtnStats = ({ children, onClick }) => (
  <button onClick={onClick} style={{ border:'1.5px solid #111', background:'#111', color:'#fff', borderRadius:8, padding:'7px 12px', fontSize:12, fontWeight:600, cursor:'pointer', fontFamily:'Poppins,sans-serif', display:'flex', alignItems:'center', gap:4, whiteSpace:'nowrap' }}>
    {children}
  </button>
);
                ...
                <div key={i} style={{border:'1px solid #efefef',borderRadius:12,overflow:'hidden',boxShadow:'0 1px 6px rgba(0,0,0,.05)'}}>
                  ...
                  <div style={{padding:'12px 14px'}}>
                    ...
                    <div style={{display:'flex',gap:8,flexWrap:'wrap'}}>
                      ...
                      <BtnStats onClick={()=>navigate(`/statistiques-evenement/${i+1}`)}><IcoStats/> Statistiques</BtnStats>

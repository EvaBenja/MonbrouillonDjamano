  ...
  return (
    <nav style={{
      ...
      <div style={{
        ...
        {/* ── LOGO : image PNG comme dans le footer, sans texte ── */}
          ...
          {langOpen && (
            <div style={{
              ...
              <div style={{
                ...
                borderBottom: '1px solid #f5f5f5', fontFamily: 'Poppins, sans-serif',
              }}>
                LANGUE
              </div>
              {[
                ...
                <div
                  ...
                  style={{
                    ...
                    background: langue === code ? '#FFF3ED' : '#fff',
                  }}
                >
                  <span style={{ fontSize: 18 }}>{flag}</span>
                  <span style={{ fontSize: 13.5, fontWeight: 600, color: '#111', fontFamily: 'Poppins, sans-serif' }}>
                    {label}
                  </span>
                  {langue === code && (
                    <div style={{
